...
import { getExtracts } from '../../Utils/api';
...
function ExtractCard() {
  ...
  .map((extract) => {
      ...
      const data = {
        ...
        extractBreeders: ['Platinum Vape', 'MKX', 'Motor City Cannacarts', 'Society C', 'Bossy', 'Kola Karts'],
        waxBreeders: ["Five Star Extracts", "Society C", "Kola Farms", "Kola Koncentrates"],
        thc: ['THC: 87.75%', 'THC: 91.08%', 'THC: 83.46%', 'THC: 85.81%', 'THC: 86.19%', 'THC: 90.41%'],
        cbd: ["", 'CBD: 0.06%', 'CBD: 0.56%', "", "", "CBD: 0.17%"],
        type: ['Hybrid', 'Indica', 'Hybrid', 'Indica', 'Sativa', 'Hybrid'],
        prices: [20.00, 15.00, 30.00, 15.00, 20.00, 20.00]
      }
        ...
        <div className={classes['card-wrapper']} key={uuid()}>
            <div className={classes.col1}>
                ...
                <Suspense fallback={<LoadingSpinner3 />}>
                    <LazyLoadImage className={classes['extract-img']}
                ...
                <div className={classes.info}>
                    <p className={classes.breeder}>{displayBreeder(extract, data, randNum6, randNum4)}</p>
